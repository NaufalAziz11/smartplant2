...
public class DaftarPerawatanAdapter  extends RecyclerView.Adapter<DaftarPerawatanAdapter.ViewHolder> {
    Context context;
    List<DataResult> data;

    public DaftarPerawatanAdapter(Context context, List<DataResult> data) {
    ...
    @NonNull
    @Override
    public DaftarPerawatanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_perawatan,
                parent, false);
        return new ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull DaftarPerawatanAdapter.ViewHolder holder, int position) {
