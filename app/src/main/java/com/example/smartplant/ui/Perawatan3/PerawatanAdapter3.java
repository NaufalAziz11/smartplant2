...
public class PerawatanAdapter3 extends RecyclerView.Adapter<PerawatanAdapter3.ViewHolder> {
    Context context;
    List<DataResult> data;

    public PerawatanAdapter3(Context context, List<DataResult> data) {
    ...
    @NonNull
    @Override
    public PerawatanAdapter3.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_perawatan,
                parent, false);
        return new PerawatanAdapter3.ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull PerawatanAdapter3.ViewHolder holder, int position) {
