...
public class KatalogAdapter2 extends RecyclerView.Adapter<KatalogAdapter2.ViewHolder>{
    Context context;
    List<DataResultKatalog> data;

    public KatalogAdapter2(Context context, List<DataResultKatalog> data) {
    ...
    @NonNull
    @Override
    public KatalogAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_katalog,
                parent, false);
        return new KatalogAdapter2.ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull KatalogAdapter2.ViewHolder holder, int position) {
