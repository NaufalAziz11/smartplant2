...
public class PerawatanAdapter2 extends RecyclerView.Adapter<PerawatanAdapter2.ViewHolder>{
    Context context;
    List<DataResult> data;

    public PerawatanAdapter2(Context context, List<DataResult> data) {
    ...
    @NonNull
    @Override
    public PerawatanAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_perawatan,
                parent, false);
        return new PerawatanAdapter2.ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull PerawatanAdapter2.ViewHolder holder, int position) {
